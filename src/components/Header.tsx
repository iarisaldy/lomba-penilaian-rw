          ...
          <div className="py-4 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <h1 className="text-xl sm:text-2xl font-extrabold tracking-tight bg-gradient-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-transparent mt-0.5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {authState.role === 'admin' && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/40 text-amber-300 text-xs font-extrabold transition-all cursor-pointer shadow-sm"
                >
