        ...
        <div className="bg-gradient-to-b from-slate-900 via-slate-900/90 to-slate-950 border border-slate-800 rounded-3xl p-6 shadow-2xl overflow-hidden relative space-y-6">
          <div className="text-center max-w-xl mx-auto space-y-1">
            ...
            <p className="text-xs text-amber-300 font-semibold">
              {participants.length > 10 ? '👑 Penetapan 6 Juara Utama (Juara 1, 2, 3 & Harapan 4, 5, 6)' : '👑 Penetapan Juara 1 & Juara 2'}
            </p>
          </div>
                  ...
                  <div className="bg-slate-900 border border-slate-700 rounded-2xl p-4 text-center shadow-lg relative overflow-hidden order-2 sm:order-1">
                    ...
                    <div className="flex items-center justify-center gap-1.5 mt-0.5 mb-1">
                      ...
                      {sortedRecap[1].participantRt && (
                        <span className="text-[10px] bg-slate-700/50 text-slate-300 font-bold px-2 py-0.5 rounded-full border border-slate-600/50">
                          {sortedRecap[1].participantRt}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="bg-gradient-to-b from-amber-500/20 via-slate-900 to-slate-900 border-2 border-amber-400 rounded-2xl p-5 text-center shadow-xl shadow-amber-500/10 relative overflow-hidden order-1 sm:order-2 scale-105">
                    ...
                    <div className="flex items-center justify-center gap-1.5 mt-0.5 mb-1">
                      ...
                      {sortedRecap[0].participantRt && (
                        <span className="text-[11px] bg-amber-500/20 text-amber-400 font-bold px-2 py-0.5 rounded-full border border-amber-500/30">
                          {sortedRecap[0].participantRt}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="bg-slate-900 border border-slate-700 rounded-2xl p-4 text-center shadow-lg relative overflow-hidden order-3">
                    ...
                    <div className="flex items-center justify-center gap-1.5 mt-0.5 mb-1">
                      ...
                      {sortedRecap[2].participantRt && (
                        <span className="text-[10px] bg-amber-900/30 text-amber-300 font-bold px-2 py-0.5 rounded-full border border-amber-800/40">
                          {sortedRecap[2].participantRt}
                        </span>
                      )}
                    </div>
                ...
                {sortedRecap[3] && (
                  <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-3 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-blue-400 uppercase tracking-wider">Juara Harapan 4</div>
                ...
                {sortedRecap[4] && (
                  <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-3 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider">Juara Harapan 5</div>
                        <div className="text-xs font-extrabold text-white">
                ...
                {sortedRecap[5] && (
                  <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-3 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="text-[10px] font-bold text-purple-400 uppercase tracking-wider">Juara Harapan 6</div>
                        <div className="text-xs font-extrabold text-white">
